...
# Set up the default format befor UnityEnvironment forces it
...
def run_training(
    ...
    # Launcher Parameters
    editor_training = options.launcher is None and options.env_path is None
    ...
    if options.launcher is not None and len(options.launcher) > 0:
        os.system(options.launcher)
